...
<!-- Mirrored from shivaaythemes.in/fithub-demo/classes by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Feb 2023 17:02:21 GMT -->
<head>
                    ...
                    <div class="class-box wow fadeInDown" data-wow-delay=".5s">
                        ...
                        <div class="class-box-contant">
                            <div class="class-box-title">
                                ...
                                <a href="class-detail"><h3 class="h3-title">Boxing & Martial<br>Arts Classes</h3></a>
                            </div>
                            <p>Suspendisse nisi libero, cursus ac magna sit amet, fermentum imperdiet nisi.</p>
                            <div class="class-full">
                                <div class="class-full-bar-box">
                    ...
                    <div class="class-box wow fadeInDown" data-wow-delay=".5s">
                        ...
                        <div class="class-box-contant">
                            <div class="class-box-title">
                                ...
                                <a href="class-detail"><h3 class="h3-title">Free Dancing<br>Classes</h3></a>
                            </div>
                            <p>Suspendisse nisi libero, cursus ac magna sit amet, fermentum imperdiet nisi.</p>
                            <div class="class-full">
                                <div class="class-full-bar-box">
            ...
            <div class="row team-slider">
                <div class="col-lg-3">
                    <div class="team-box wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <div class="team-content">
                            <a href="team-detail"><h3 class="h3-title team-text-color">Desert Antony</h3></a>
                ...
                <div class="col-lg-3">
                    <div class="team-box wow fadeInDown" data-wow-delay=".5s">
                        ...
                        <div class="team-content">
                            <a href="team-detail"><h3 class="h3-title team-text-color">Kate Johnson</h3></a>
                            <span>Fitness Trainer</span>
                            <div class="team-social">
                                <ul>
                                    <li>
                ...
                <div class="col-lg-3">
                    <div class="team-box wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <div class="team-content">
                            <a href="team-detail"><h3 class="h3-title team-text-color">John Hard</h3></a>
                            <span>Fitness Trainer</span>
                            <div class="team-social">
                                <ul>
                                    <li>
                ...
                <div class="col-lg-3">
                    <div class="team-box wow fadeInDown" data-wow-delay=".5s">
                        ...
                        <div class="team-content">
                            <a href="team-detail"><h3 class="h3-title team-text-color">Zahra Sharif</h3></a>
                            <span>Fitness Trainer</span>
                            <div class="team-social">
                                <ul>
                                    <li>
                ...
                <div class="col-lg-3">
                    <div class="team-box wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <div class="team-content">
                            <a href="team-detail"><h3 class="h3-title team-text-color">Ruth Edwards</h3></a>
                            <span>Fitness Trainer</span>
                            <div class="team-social">
                                <ul>
                                    <li>
                ...
                <div class="col-lg-4">
                    <div class="pricing-box wow fadeInUp" data-wow-delay=".5s">
                        <div class="pricing-title-box pricing-one">
                            <h3 class="h3-title">Standard Plan</h3>
                                ...
                                <div class="pricing-point">
                                    <ul>
                                        <li>
                                            ...
                                            <p>Unlimited club access</p>
                                        </li>
                                        <li>
                                            <img src="assets/images/check.png" alt="Check">
                                            <p>Group attendance</p>
                                        </li>
                                        <li>
                                            <img src="assets/images/check.png" alt="Check">
                                            <p>Gym visits</p>
                                        ...
                                        <li>
                                            <img src="assets/images/check.png" alt="Check">
                                            <p>Visits to the bath complex</p>
                                        </li>
                                        <li>
                                            <img src="assets/images/check.png" alt="Check">
                                            <p>Gym, fight club</p>
                ...
                <div class="col-lg-4">
                    <div class="pricing-box wow fadeInDown" data-wow-delay=".5s">
                        <div class="pricing-title-box pricing-two">
                            <h3 class="h3-title">Standard Plan</h3>
                            <h2 class="h2-title">$45<span>/Month</span></h2>
                        </div>
                        <div class="pricing-content-box">
                            <div class="pricing-content">
                                <div class="pricing-point">
                ...
                <div class="col-lg-4">
                    <div class="pricing-box wow fadeInUp" data-wow-delay=".5s">
                        <div class="pricing-title-box pricing-three">
                            <h3 class="h3-title">Standard Plan</h3>
                            <h2 class="h2-title">$55<span>/Month</span></h2>
                        </div>
                        <div class="pricing-content-box">
                            <div class="pricing-content">
                                <div class="pricing-point">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="testimonial-title">
                        ...
                        <h2 class="h2-title">What Our Clients Says</h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="testimonial-box wow fadeInUp" data-wow-delay=".5s">
                        <div class="client-box">
                            ...
                            <div class="client-name">
                                <h3 class="h3-title">Scott Swanson</h3>
...
<!-- Mirrored from shivaaythemes.in/fithub-demo/classes by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Feb 2023 17:02:22 GMT -->
</html>