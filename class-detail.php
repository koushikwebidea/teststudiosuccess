...
<!-- Mirrored from shivaaythemes.in/fithub-demo/class-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Feb 2023 17:02:22 GMT -->
<head>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="banner-breadcum">
                        <ul>
                            ...
                            <li><i class="fa fa-chevron-right"></i></li>
                            <li><a href="class-detail.php">Weight Lifting Class</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="class-detail-category wow fadeInLeft" data-wow-delay=".5s">
                        <ul>
                            <li><a href="class-detail.php" class="active"><span>Weight Lifting Classes</span><i class="fa fa-chevron-right"></i></a></li>
                            <li><a href="class-detail.php"><span>Cardio & Strenght Classes</span><i class="fa fa-chevron-right"></i></a></li>
                            <li><a href="class-detail.php"><span>Power Yoga Classes</span><i class="fa fa-chevron-right"></i></a></li>
                            <li><a href="class-detail.php"><span>Health Nutrition Classes</span><i class="fa fa-chevron-right"></i></a></li>
                            <li><a href="class-detail.php"><span>Boxing & Martial Arts Classes</span><i class="fa fa-chevron-right"></i></a></li>
                            <li><a href="class-detail.php"><span>Free Dancing Classes</span><i class="fa fa-chevron-right"></i></a></li>
                        </ul>
                    </div>
                    <div class="download-brochure wow fadeInLeft" data-wow-delay=".6s">
                        ...
                        <ul>
                            <li>
                                <a href="assets/images/placeholder-pdf.pdf" download="placeholder-pdf.php">
                    ...
                    <div class="class-detail-content">
                        ...
                        <div class="class-trainer-review">
                            <div class="class-trainer">
                                ...
                                <div class="class-trainer-text">
                                    <a href="team-detail.php">Desert Antony</a>
                        ...
                        <div class="class-detail-trainer-box wow fadeInUp" data-wow-delay=".5s">
                            ...
                            <div class="class-trainer-box-text">
                                ...
                                <a href="team-detail.php" class="sec-btn-link">Read More</a>
                            </div>
                        </div>
...
<!-- Mirrored from shivaaythemes.in/fithub-demo/class-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Feb 2023 17:02:24 GMT -->
</html>