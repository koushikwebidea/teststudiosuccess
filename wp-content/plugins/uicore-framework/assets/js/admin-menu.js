...
exports.default = {
    ...
    methods: {
        ...
        setColor: function setColor() {
            jQuery('.item-color-prev-' + this.id + '').css('--ui-badge-color', this.getColorCode());
            jQuery('[name="menu-item-badge-color[' + this.id + ']"]').val(this.value);
        },
        ...
        addHandlers: function addHandlers(el) {
            ...
            var oldVal = jQuery('[name="menu-item-badge-color[' + id + ']"]').val();
            this.value = oldVal ? oldVal : 'Primary';
...
var _iconPicker = __webpack_require__(326);

var _iconPicker2 = _interopRequireDefault(_iconPicker);

var _colorPicker = __webpack_require__(329);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_iconPicker_vue__ = __webpack_require__(145);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_63e293b0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_iconPicker_vue__ = __webpack_require__(328);
var disposed = false
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_colorPicker_vue__ = __webpack_require__(146);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_20723bd8_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_colorPicker_vue__ = __webpack_require__(331);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm.show
        ? _c("color", {
            attrs: { background: _vm.value, isglobal: false, mini: true },
            on: {
              set: function($event) {
                return _vm.close()
              }
