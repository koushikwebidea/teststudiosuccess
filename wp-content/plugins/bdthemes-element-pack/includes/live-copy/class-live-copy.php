...
class ElementPack_Live_Copy {
    ...
    public function live_copy_enqueue(){
        ...
        wp_enqueue_script( 'bdt-live-copy-scripts', BDTEP_URL . 'includes/live-copy/assets/ep-live-copy.min.js', [ 'jquery', 'elementor-editor', 'bdt-live-copy-storage', 'elementor-editor'], BDTEP_VER, true);
