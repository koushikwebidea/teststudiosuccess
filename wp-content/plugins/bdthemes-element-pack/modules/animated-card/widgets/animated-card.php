...
class Animated_Card extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-item' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-content' => 'max-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-content' => 'text-align: {{VALUE}} !important;',
				],
				'separator' => 'before'
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-animated-card .bdt-circle::before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .bdt-animated-card .bdt-circle' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .bdt-animated-card .bdt-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-animated-card:hover .bdt-circle::before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card:hover .bdt-circle::before'  => 'border-color: {{VALUE}};',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-img-wrap .bdt-img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'      => 'css_filters',
				'selector'  => '{{WRAPPER}} .bdt-animated-card .bdt-img-wrap .bdt-img',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-img-wrap .bdt-img' => 'opacity: {{SIZE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-img-wrap .bdt-img' => 'transition-duration: {{SIZE}}s',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-item:hover .bdt-img-wrap .bdt-img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card.bdt-pepsi-style-1:hover .bdt-item .bdt-img-wrap .bdt-img' => 'left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .bdt-animated-card.bdt-pepsi-style-2:hover .bdt-item .bdt-img-wrap .bdt-img' => 'right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}}.bdt-animated-card:hover .bdt-img-wrap .bdt-img',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.bdt-animated-card:hover .bdt-img-wrap .bdt-img' => 'opacity: {{SIZE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-title' => 'padding-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-animated-card .bdt-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-title:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-sub-title' => 'padding-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-sub-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-animated-card .bdt-sub-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card:hover .bdt-sub-title:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-animated-card .bdt-text',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-text' => 'padding-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-text:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-animated-card .bdt-text:hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-btn a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-animated-card .bdt-btn a svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-animated-card .bdt-btn a',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .bdt-animated-card .bdt-btn a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .bdt-animated-card .bdt-btn a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-btn a:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-animated-card .bdt-btn a:hover svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-animated-card .bdt-btn a:hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-animated-card .bdt-btn a:hover' => 'border-color: {{VALUE}};',
				],
				'condition' => [
	...
	// public function render_animated_badge() {
...
?>
		<div class="bdt-img-wrap">
			<img class="bdt-img" src="<?php echo esc_url($thumb_url); ?>" alt="<?php echo esc_html($settings['title_text']); ?>">
		</div>
	<?php
	}
	...
	public function render_animated_content() {
		...
		$this->add_render_attribute('animated-title', 'class', 'bdt-title');
		...
		$this->add_render_attribute( 'animated_sub_title', 'class', 'bdt-sub-title' );
		...
		$this->add_render_attribute('readmore', 'class', ['bdt-animated-readmore', 'bdt-display-inline-block']);
	...
	public function render() {
		...
		$this->add_render_attribute('animated-card', 'class', ['bdt-animated-card', 'bdt-pepsi-' . $settings['layout_direction'] . '']);
