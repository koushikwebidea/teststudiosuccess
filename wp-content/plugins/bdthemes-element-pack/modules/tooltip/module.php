...
class Module extends Element_Pack_Module_Base {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script('popper-js', BDTEP_ASSETS_URL . 'vendor/js/popper' . $suffix . '.js', ['jquery'], null, true);
		wp_enqueue_script('tippy-js', BDTEP_ASSETS_URL . 'vendor/js/tippy.all' . $suffix . '.js', ['jquery'], null, true);
	}
