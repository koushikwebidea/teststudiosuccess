...
class Instagram extends Module_Base {
    ...
    public function render() {
        ...
        $this->add_render_attribute('instagram', 'class', 'bdt-child-width-1-' . esc_attr($columns_mobile) . '@m');
        $this->add_render_attribute('instagram', 'class', 'bdt-child-width-1-' . esc_attr($columns_tablet) . '@s');
        $this->add_render_attribute('instagram', 'class', 'bdt-child-width-1-' . esc_attr($columns));
