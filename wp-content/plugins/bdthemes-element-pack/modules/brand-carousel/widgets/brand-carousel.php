<?php
	...
	class Brand_Carousel extends Module_Base {
		...
		protected function register_controls() {
			...
			$this->add_control(
				...
				[
					...
					'prefix_class' => 'bdt-ep-brand-carousel-icon--',
				]
			);
			...
			$this->register_navigation_style_controls('brand-carousel');
		...
		public function render_header() {
			...
			$this->add_render_attribute( 'carousel', 'class', 'bdt-brand-carousel' );
