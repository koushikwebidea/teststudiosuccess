...
class Element_Pack_Loader {
	...
	public function register_site_scripts() {
		...
		if (element_pack_is_widget_enabled('user-login') or element_pack_is_widget_enabled('user-login') or element_pack_is_widget_enabled('contact-form')) {
		...
		if (element_pack_is_widget_enabled('table-of-content')) {
			wp_register_script('tocify', BDTEP_ASSETS_URL . 'vendor/js/tocify' . $suffix . '.js', ['jquery'], null, true);
		}
		...
		if (element_pack_is_widget_enabled('interactive-card') or element_pack_is_widget_enabled('image-expand') or element_pack_is_widget_enabled('animated-heading') or element_pack_is_widget_enabled('horizontal-scroller')) {
			wp_register_script('gsap', BDTEP_ASSETS_URL . 'vendor/js/gsap' . $suffix . '.js', [], '3.9.1', true);
		}
		if (element_pack_is_widget_enabled('image-expand') or element_pack_is_widget_enabled('animated-heading')) {
			wp_register_script('split-text-js', BDTEP_ASSETS_URL . 'vendor/js/SplitText' . $suffix . '.js', ['jquery', 'gsap'], '3.9.1', true);
		}
		...
		if (element_pack_is_widget_enabled('horizontal-scroller')) {
			wp_register_script('scroll-trigger-js', BDTEP_ASSETS_URL . 'vendor/js/ScrollTrigger' . $suffix . '.js', ['gsap'], '3.9.1', true);
			wp_register_script('scroll-to-plugin-js', BDTEP_ASSETS_URL . 'vendor/js/ScrollToPlugin' . $suffix . '.js', ['gsap'], '3.9.1', true);
		}
