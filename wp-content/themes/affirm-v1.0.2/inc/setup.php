...
if (!function_exists('level_setup')) :
	...
	function level_setup()
	{
		 ...
		 * to change 'affirm' to the name of your theme in all the template files.
		 */
		load_theme_textdomain('affirm', get_template_directory() . '/languages');
		...
		register_nav_menus(array(
			'primary' => esc_html__('Primary', 'affirm'),
		));
