...
<!-- Mirrored from shivaaythemes.in/fithub-demo/blog-detail by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Feb 2023 17:02:34 GMT -->
<head>
                                   ...
                                   <li class="sub-items">
                                    ...
                                    <li class="sub-items">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="pricing" title="Pricing Table">Pricing Table</a></li>
                                    ...
                                    <li class="sub-items active">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="blog-list" title="Blog Grid">Blog List</a></li>
                ...
                <div class="col-lg-8">
                    <div class="blog-detail-info-content">
                        ...
                        <div class="blog-big-main-title">
                            <h2 class="h2-title">Going to the gym for the first time</h2>
                        </div>
                        <p>Aenean molestie dictum nibh, non ullamcorper ex molestie id. Maecenas quis sem id elit sodales finibus et sed nunc. Aliquam dapibus vitae ligula id porta. Cras non quam pharetra, placerat justo at, scelerisque arcu. Ut ipsum urna, vulputate et mauris blandit, porttitor laoreet ante.</p>
                        <p>Phasellus non dui urna. Nunc interdum augue sem, sed malesuada tortor placerat vel. Pellentesque efficitur eleifend enim eget fringilla. Proin tincidunt dui eu velit convallis lobortis. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tristique diam nisi, eget ultricies elit gravida non. Interdum et malesuada fames ac ante ipsum primis in faucibus. Sed viverra vulputate eros at imperdiet.</p>
                        <div class="blog-img-box">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="blog-img wow fadeInUp" data-wow-delay=".5s">
                                        <img src="assets/images/blog-big1.1.jpg" alt="Blog">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="blog-img wow fadeInDown" data-wow-delay=".5s">
                                        <img src="assets/images/blog-big1.2.jpg" alt="Blog">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <h3 class="h3-title">Fitness for Health Resolution</h3>
                        <p>Nunc laoreet felis massa, eget fringilla purus pretium sed. Quisque vel quam iaculis, aliquet neque quis, imperdiet leo. Donec sit amet lobortis arcu. Vivamus ultricies orci elit, sed rhoncus tellus placerat semper. Suspendisse porttitor nisi tincidunt, dapibus magna eget, interdum arcu. Curabitur sit amet massa sapien. Sed porta dolor felis, in dignissim urna ornare id. Ut convallis non dolor a iaculis.</p>
                        <div class="blog-text-box wow fadeInUp" data-wow-delay=".5s">
                            <div class="quort-box">
                                <img src="assets/images/quote.png" alt="Quote">
                            </div>
                            <p>Mattis lorem class sapien taciti inceptos at ultrices quis risus nulla rutrum tempor ligula lectus elit lobortis sodales.</p>
                        </div>
                        <p>Sed bibendum faucibus arcu. Etiam volutpat lectus sed velit euismod, in iaculis odio posuere. Vestibulum cursus ex sed imperdiet mattis. Mauris pellentesque ex in tempor rutrum. Morbi aliquam odio sit amet arcu elementum, sed pretium elit iaculis. Phasellus sed mauris pretium, varius tortor et, lacinia nisl.</p>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="blog-comment-title">
                                        <div class="subtitle">
                                            <h2 class="h2-subtitle">Read comment</h2>
                                        </div>
                                        <h2 class="h2-title">Comments</h2>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="comment-box">
                                            <div class="client-img">
                                                <img src="assets/images/comment-client1.jpg" class="rounded-circle" alt="Client">
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="comment-box">
                                            <div class="client-img">
                                                <img src="assets/images/comment-client2.jpg" class="rounded-circle" alt="Client">
                                            </div>
                                            <div class="comment-content">
                                                <div class="comment-name-reply">
                                                    <div class="client-name">
                        ...
                        <div class="write-comment">
                            <div class="write-comment-title">
                                <div class="subtitle">
                                    <h2 class="h2-subtitle">Write Comments</h2>
                                </div>
                                <h2 class="h2-title">Leave A Comment</h2>
                            </div>
                            <form class="leave-reply-form">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-box mb-0">
                                            <button type="submit" class="sec-btn"><span>Post Now</span></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="recent-post-text">
                                    <a href="blog-detail">Consequat urna proin aliqu platea quisque massa diam elementum.</a>
                            ...
                            <li>
                                ...
                                <div class="recent-post-text">
                                    <a href="blog-detail">Interdum convallis praesent justo praesent euis</a>
                                    <a href="javascript:void(0);">7 March 2021</a>
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <div class="recent-post-text">
                                    <a href="blog-detail">Dapibus nonummy do Maecenas fermeum rutrum vehicula bith sagittis.</a>
                                    <a href="javascript:void(0);">7 March 2021</a>
                                </div>
                            </li>
                        </ul>
...
<!-- Mirrored from shivaaythemes.in/fithub-demo/blog-detail by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Feb 2023 17:02:35 GMT -->
</html>